...
export async function listContributions() {
  const { data, error } = await supabase
    .from('contributions')
    .select('id, amount, contribution_date, description, status, created_at, member:members(id, profile:profiles(full_name)), creator:profiles!contributions_created_by_fkey(full_name)')
